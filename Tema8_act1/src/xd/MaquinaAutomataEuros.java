...
// * caso contrario
 ...
 System.out.println("La maquina no dispone del cambio
necesario");
 Devolver(Maquina,Acumulado);
 Anulado = true;
 }
...
// * 'Maquina'
 ...
 (MaquinaModeloSencillo Maquina, float Cantidad)
...
//falta de precision
		...
		System.out.println(
				"Recoja el importe: " + Monedas1 + "monedas de un euro y " + Monedas01 + " monedas de 0.1 euros");
